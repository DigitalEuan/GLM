...
└── glm_universal/README.md          v1.23.0 — the active runtime, the map of the eleven sub-packages
    ...
    ├── reasoning/README.md          the <!--figure:reasoning-modules-->89<!--/figure--> reasoning modules, and what each one is reachable as
    ...
    ├── tests/README.md              <!--figure:test-files-->106 test files<!--/figure-->: what each one checks, and why
...
glm_lean/RequestProject/GLM/README.md   the Lean 4 development: <!--figure:lean-files-->126 Lean files<!--/figure-->, no sorry
...
LEAN_ADDRESS_STUDY.md                   a deterministic Leech address for each of the 3582
...
https://github.com/DigitalEuan/GLM (../)                     FOUNDATION the director and collector. 
  ...
  │                         <!--figure:suite-->4,180 tests across 105 of the 106 test files, 16,288 subtests, outside the document check<!--/figure-->,
