...
└── glm_universal/README.md          v1.15.0 — the active runtime, the map of the eleven sub-packages
    ...
    ├── reasoning/README.md          the 59 reasoning modules, and what each one is reachable as
    ...
    ├── runtime/README.md            the 21 query kinds, the 51 report subjects, the session API
    ...
    ├── evaluation/README.md         the 134-case end-to-end CLI evaluation, and how it scores
    ├── tests/README.md              74 test files: what each one checks, and why
...
glm_lean/RequestProject/GLM/README.md   the Lean 4 development: 97 Lean files, no sorry
...
LEAN_ADDRESS_STUDY.md                   a deterministic Leech address for each of the 2826
...
TIE_BREAK_STUDY.md                      what a nearest-point tie is, and what breaking it
                                        by index costs
PROJECT_DIRECTIVES.md                   the nine standing rules, each naming the instrument
                                        that enforces it
...
https://github.com/DigitalEuan/GLM (../)                     FOUNDATION the director and collector. 
  ...
  │                         **v1.15.0 — feature complete.** Eleven sub-packages,
  ...
  │                         21 query kinds, 51 report subjects, 8 registers
  ...
  │                         A 134-case end-to-end evaluation drives GLM.py in
  │                         a fresh interpreter over every query kind and
  │                         every report subject.
  │                         3,163 tests across 73 of the 74 test files, 12,838 subtests, outside the document check,
