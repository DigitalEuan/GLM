...
└── glm_universal/README.md          v1.15.0 — the active runtime, the map of the eleven sub-packages
    ...
    ├── runtime/README.md            the 21 query kinds, the 52 report subjects, the session API
    ...
    ├── tests/README.md              75 test files: what each one checks, and why
...
glm_lean/RequestProject/GLM/README.md   the Lean 4 development: 99 Lean files, no sorry
...
LEAN_ADDRESS_STUDY.md                   a deterministic Leech address for each of the 2893
...
https://github.com/DigitalEuan/GLM (../)                     FOUNDATION the director and collector. 
  ...
  │                         21 query kinds, 52 report subjects, 8 registers
  ...
  │                         3,179 tests across 74 of the 75 test files, 12,839 subtests, outside the document check,
