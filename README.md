...
└── glm_universal/README.md          v1.17.0 — the active runtime, the map of the eleven sub-packages
    ...
    ├── runtime/README.md            the 21 query kinds, the 63 report subjects, the session API
    ...
    ├── evaluation/README.md         the <!--figure:evaluation-case-count-->147<!--/figure-->-case end-to-end CLI evaluation, and how it scores
    ├── tests/README.md              <!--figure:test-files-->89 test files<!--/figure-->: what each one checks, and why
...
glm_lean/RequestProject/GLM/README.md   the Lean 4 development: <!--figure:lean-files-->111 Lean files<!--/figure-->, no sorry
...
LEAN_ADDRESS_STUDY.md                   a deterministic Leech address for each of the 3187
...
https://github.com/DigitalEuan/GLM (../)                     FOUNDATION the director and collector. 
  ...
  │                         21 query kinds, 63 report subjects, 8 registers
  ...
  │                         A <!--figure:evaluation-case-count-->147<!--/figure-->-case end-to-end evaluation drives GLM.py in
