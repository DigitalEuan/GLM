...
└── glm_universal/README.md          v1.20.0 — the active runtime, the map of the eleven sub-packages
    ...
    ├── reasoning/README.md          the <!--figure:reasoning-modules-->87<!--/figure--> reasoning modules, and what each one is reachable as
    ...
    ├── evaluation/README.md         the <!--figure:evaluation-case-count-->172<!--/figure-->-case end-to-end CLI evaluation, and how it scores
    ...
    ├── tests/README.md              <!--figure:test-files-->101 test files<!--/figure-->: what each one checks, and why
...
glm_lean/RequestProject/GLM/README.md   the Lean 4 development: <!--figure:lean-files-->122 Lean files<!--/figure-->, no sorry
...
LEAN_ADDRESS_STUDY.md                   a deterministic Leech address for each of the 3455
...
https://github.com/DigitalEuan/GLM (../)                     FOUNDATION the director and collector. 
  ...
  │                         **v1.20.0 — feature complete.** Eleven sub-packages,
  ...
  │                         A <!--figure:evaluation-case-count-->172<!--/figure-->-case end-to-end evaluation drives GLM.py in
  │                         a fresh interpreter over every query kind and
  │                         every report subject.
  │                         <!--figure:suite-->4,038 tests across 100 of the 101 test files, 15,644 subtests, outside the document check<!--/figure-->,
