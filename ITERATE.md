...
**Deciding figure.** The suite is <!--figure:test-files-->109 test files<!--/figure--> and 7 instruments, each signed against a digest of everything it depended on, so a change re-runs what it touched rather than all of it.
...
| **release** | `python3 -m glm_universal.signoff --release --jobs 8` | all <!--figure:test-files-->109 test files<!--/figure--> and all 7 instruments, exhaustive cases on, ledger ignored | once, closing the round |
