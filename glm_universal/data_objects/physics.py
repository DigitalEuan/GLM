"""Physics carriers: the 660-concept dimensional register in 24 dimensions.

The register
------------
660 named physical quantities across 26 domains, ingested from
...
def load_physics_register() -> Tuple[Quantity, ...]:
    """The 660 quantities, parsed once from the frozen snapshot."""
