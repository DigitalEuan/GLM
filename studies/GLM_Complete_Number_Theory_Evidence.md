...
The Lean development is 122 files under `RequestProject/GLM/`, all building
...
fidelity is provable (122 Lean files, 0 `sorry`) and measurable (exact integer
...
| the Lean development | `RequestProject/GLM/` (122 files) and its mirror `overlay/glm_lean/` |
